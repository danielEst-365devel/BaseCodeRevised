...
CREATE TABLE `API_LOG` (
  ...
  `API_METHOD_NAME` varchar(100) NOT NULL,
  `API_PARAMETERS` longtext DEFAULT NULL,
  `API_RESPONSE` longtext DEFAULT NULL,
  `API_IP_ADDRESS` varchar(45) DEFAULT NULL,
  `CREATE_DATE` timestamp NOT NULL DEFAULT current_timestamp(),
  `API_TRACE_ID` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`API_ID`),
  KEY `IDX_API_LOG_METHOD_DATE` (`API_METHOD_NAME`, `CREATE_DATE`),
  KEY `IDX_API_LOG_TRACE_ID` (`API_TRACE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
